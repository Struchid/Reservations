# Generated by Django 4.0.4 on 2022-05-15 12:59
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_to', models.DateTimeField(
                    default=datetime.datetime(2022, 5, 15, 13, 59, 9, 335256, tzinfo=utc))
                 ),
                ('meeting_room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                   related_name='reservation', to='meeting_rooms.meetingroom')),
                ('organizer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
                                                to=settings.AUTH_USER_MODEL)),
                ('participants', models.ManyToManyField(related_name='reservation_participant',
                                                        to=settings.AUTH_USER_MODEL)),
            ],
            options={
